...
router.put('/upload/kk/:id', isAuthenticated, upload.single('image'), formController.upload_kk);
router.put('/upload/npwp/:id', isAuthenticated, upload.single('image'), formController.upload_npwp);
